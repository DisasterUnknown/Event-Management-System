...
namespace Root_Folder
{
    internal abstract class Person
    {
        ...
        public Person(string name, int age, string password, string email, long phoneNo, string role) 
        {
            this.name = name;
            this.age = age;
        ...
        // Abstract Methods
        public abstract void Register(string name, int age, string password, string comPassword, string email, long phoneNo, string role, Form f1);
